                ...
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('shop.create') }}" class="btn btn-primary">
                            <i class="fe fe-plus"></i> Create Shop
                        </a>
                    </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom w-100" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Store Number</th>
                                    <th class="wd-15p border-bottom-0">Image</th>
                                    <th class="wd-15p border-bottom-0">Latitude</th>
                                    <th class="wd-15p border-bottom-0">Longitude</th>
